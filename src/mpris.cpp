...
//    connection.registerObject("/", new RootObject(this), QDBusConnection::ExportAllContents);
    ...
    connection.registerService("org.mpris.tvoeradio");
    connection.registerService("org.mpris.MediaPlayer2.tvoeradio");
}

MPRIS::~MPRIS()
{
    QDBusConnection::sessionBus().unregisterService("org.mpris.tvoeradio");
    QDBusConnection::sessionBus().unregisterService("org.mpris.MediaPlayer2.tvoeradio");
}
